...
namespace ShutdownTimer
{
    class Action
    {
        ...
        /// <summary>
        /// ShutdownOrReboot(true, false) -- мягкая перезагрузка |
        /// ShutdownOrReboot(true, true) -- жесткая перезагрузка |
        /// ShutdownOrReboot(false, false) -- мягкое выключение |
        /// ShutdownOrReboot(false, true) -- жесткое выключение
        /// </summary>
        /// <returns></returns>
        public int ShutdownOrReboot(bool RSh, bool Force)
        {
